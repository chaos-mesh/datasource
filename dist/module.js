...
function () {
  ...
  AnnotationsQueryCtrl.prototype.initDropDown = function () {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var _this = this;

      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        this.datasource.queryNamespaces().then(function (result) {
          _this.namespaces = result.data.map(function (ns) {
            return {
              text: ns,
              value: ns
            };
...
function (_super) {
  ...
  function DataSource(instanceSettings) {
    ...
    _this.handleErrors = function (err, target) {
      ...
      if (err.data) {
        if (typeof err.data === 'string') {
          ...
          error.message = _this.safeStringifyValue(err.data.error);
        }
      } else if (err.message) {
    ...
    _this.safeStringifyValue = function (value, space) {
      if (!value) {
        return '';
      }
    ...
    _this.defaultUrl = instanceSettings.jsonData.defaultUrl;
    return _this;
  }

  DataSource.prototype._request = function (url, data) {
    if (data === void 0) {
      data = {};
    }
  ...
  DataSource.prototype.checkLiveness = function () {
    var url = '/ping';
    return this._request(url)["catch"](function (err) {
      console.error(err);
    });
  };

  DataSource.prototype.queryNamespaces = function () {
    var url = '/api/common/namespaces';
    return this._request(url)["catch"](function (err) {
      console.error(err);
    });
  };

  DataSource.prototype.queryEvents = function (req) {
    var _this = this;

    var url = '/api/events/dry';
    var data = {
    ...
    return this._request(url, data)["catch"](function (err) {
      throw _this.handleErrors(err, req);
    });
  };
  ...
  DataSource.prototype.query = function (options) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        range = options.range;
        from = this.toRFC3339TimeStamp(range.from.toDate());
        to = this.toRFC3339TimeStamp(range.to.toDate());
        data = options.targets.map(function (target) {
          ...
          _this.queryEvents(query).then(function (response) {
  ...
  DataSource.prototype.toRFC3339TimeStamp = function (date) {
    ...
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            range = options.range;
            query = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(options.annotation, _types__WEBPACK_IMPORTED_MODULE_4__["defaultQuery"]);
          ...
          case 1:
            ...
            , response.data.map(function (event) {
              var eventPage = _this.defaultUrl + "/experiments/" + event.experiment + "?namespace=" + event.namespace + "&kind=" + event.kind + "&event=" + event.id;
              var regionEvent = {
...
function (_super) {
  ...
  function QueryEditor(props) {
    ...
    _this.onNamespaceChange = function (item) {
      var namespace = item.value;
      _this.query.namespace = namespace;
    ...
    _this.onKindChange = function (item) {
      var kind = item.value;
      _this.query.kind = kind;
    ...
    _this.onExperimentChange = function (event) {
      var experiment = event.target.value;
      _this.query.experiment = experiment;
    ...
    _this.query = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(_this.props.query, _types__WEBPACK_IMPORTED_MODULE_4__["defaultQuery"]);
    _this.state = {
      allNamespaces: [],
      namespace: _this.query.namespace,
      kind: _this.query.kind,
      experiment: _this.query.experiment
    };
    return _this;
  }
  ...
  QueryEditor.prototype.componentDidMount = function () {
    ...
    this.dataSource.queryNamespaces().then(function (results) {
      _this.setState({
        allNamespaces: results.data.map(function (ns) {
          return {
            label: ns,
            value: ns
          };
  ...
  QueryEditor.prototype.render = function () {
    ...
    var selectedKind = kindOptions.find(function (o) {
      return o.value === _this.query.kind;
    });
    var selectedNamespace = allNamespaces.find(function (o) {
      return o.value === _this.query.namespace;
    });
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      width: 12,
      tooltip: "Namespace of Chaos Experiments"
    }, "Experiment Namespace"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Select, {
      ...
      width: 10,
      tooltip: "Name of the Chaos Experiment"
    }, "Experiment Name"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Input, {
      type: "text",
      ...
      width: 8
    }, "Chaos Kind"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Select, {
      width: 8,
      value: selectedKind,
